 ...
 */
define(['./when-60b00257', './Check-4274a1fd', './Math-223a3507', './Cartesian2-5026e7e5', './Transforms-b6bf8f4b', './RuntimeError-027c380a', './WebGLConstants-779bf0bc', './ComponentDatatype-57df98f7', './GeometryAttribute-75cd9829', './GeometryAttributes-130e4d69', './AttributeCompression-adb0ed0e', './GeometryPipeline-f140eb79', './EncodedCartesian3-005a10a6', './IndexDatatype-2a4a42c9', './IntersectionTests-61987487', './Plane-62bd9959', './VertexFormat-707c476a', './GeometryInstance-68d5fec1', './arrayRemoveDuplicates-a7eaab51', './BoundingRectangle-b2c13d6f', './EllipsoidTangentPlane-ccb7a374', './OrientedBoundingBox-c218bef5', './CoplanarPolygonGeometryLibrary-fdb2b2dd', './ArcType-a321d0d9', './EllipsoidRhumbLine-62b51287', './PolygonPipeline-24d3b013', './PolygonGeometryLibrary-25339cb7'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, VertexFormat, GeometryInstance, arrayRemoveDuplicates, BoundingRectangle, EllipsoidTangentPlane, OrientedBoundingBox, CoplanarPolygonGeometryLibrary, ArcType, EllipsoidRhumbLine, PolygonPipeline, PolygonGeometryLibrary) { 'use strict';
