 ...
 */
define(['./when-60b00257', './Check-4274a1fd', './Math-223a3507', './Cartesian2-5026e7e5', './Transforms-b6bf8f4b', './RuntimeError-027c380a', './WebGLConstants-779bf0bc', './ComponentDatatype-57df98f7', './GeometryAttribute-75cd9829', './GeometryAttributes-130e4d69', './IndexDatatype-2a4a42c9', './GeometryOffsetAttribute-c91bd9c1', './EllipsoidRhumbLine-62b51287', './PolygonPipeline-24d3b013', './RectangleGeometryLibrary-0585d428'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
