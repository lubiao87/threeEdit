 ...
 */
define(['./when-60b00257', './Check-4274a1fd', './Math-223a3507', './Cartesian2-5026e7e5', './Transforms-b6bf8f4b', './RuntimeError-027c380a', './WebGLConstants-779bf0bc', './ComponentDatatype-57df98f7', './GeometryAttribute-75cd9829', './GeometryAttributes-130e4d69', './IndexDatatype-2a4a42c9', './createTaskProcessorWorker', './GeometryOffsetAttribute-c91bd9c1', './VertexFormat-707c476a', './BoxGeometry-95a3be6e', './CylinderGeometryLibrary-453c06cc', './CylinderGeometry-8f3937ad', './EllipsoidGeometry-b9a11297', './Color-635c67fa'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, createTaskProcessorWorker, GeometryOffsetAttribute, VertexFormat, BoxGeometry, CylinderGeometryLibrary, CylinderGeometry, EllipsoidGeometry, Color) { 'use strict';
