 ...
 */
define(['./when-60b00257', './Check-4274a1fd', './Math-223a3507', './Cartesian2-5026e7e5', './Transforms-b6bf8f4b', './RuntimeError-027c380a', './WebGLConstants-779bf0bc', './AttributeCompression-adb0ed0e', './IndexDatatype-2a4a42c9', './IntersectionTests-61987487', './Plane-62bd9959', './createTaskProcessorWorker', './EllipsoidTangentPlane-ccb7a374', './OrientedBoundingBox-c218bef5', './Color-635c67fa'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
