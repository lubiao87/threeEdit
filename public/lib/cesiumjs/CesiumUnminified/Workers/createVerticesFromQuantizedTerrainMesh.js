 ...
 */
define(['./when-60b00257', './Check-4274a1fd', './Math-223a3507', './Cartesian2-5026e7e5', './Transforms-b6bf8f4b', './RuntimeError-027c380a', './WebGLConstants-779bf0bc', './ComponentDatatype-57df98f7', './AttributeCompression-adb0ed0e', './IndexDatatype-2a4a42c9', './IntersectionTests-61987487', './Plane-62bd9959', './WebMercatorProjection-3d61e45a', './createTaskProcessorWorker', './EllipsoidTangentPlane-ccb7a374', './OrientedBoundingBox-c218bef5', './TerrainEncoding-f5b2fadd'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
