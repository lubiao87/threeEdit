...
function initMXPQ() {
    ...
    $("#btn_mxpq_Clipping1").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.Z;
    });
    $("#btn_mxpq_Clipping2").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.ZR;
    });
    $("#btn_mxpq_Clipping3").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.X;
    });
    $("#btn_mxpq_Clipping4").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.XR;
    });

    $("#btn_mxpq_Clipping5").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.Y;
    });
    $("#btn_mxpq_Clipping6").click(function () {
        if (thisWidget.clipTileset)
            thisWidget.clipTileset.type = parent.okay3d.tiles.TilesClipPlan.Type.YR;
    });
