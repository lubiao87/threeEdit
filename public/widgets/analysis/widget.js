...
okay3d.widget.bindClass(okay3d.widget.BaseWidget.extend({
    ...
    addKSY: function (options) {
        ...
        var thisViewField = new okay3d.analysi.ViewShed3D(this.viewer, {
    ...
    createFLFX: function () {
        ...
        var that = this;
        this.measureObj = new okay3d.analysi.MeasureVolume(viewer, {
            heightLabel: true,
            offsetLabel: false,
            onStart: function () {
    ...
    showDXKWClippingPlanes: function (positions) {
        ...
        this.TerrainClip = new okay3d.analysi.TerrainClip(viewer, {
            positions: positions,
            height: height,
            wall: true,
        ...
        this.TerrainClip2 = new okay3d.analysi.TerrainClipPlan(viewer, {
            positions: positions,
            height: height,
            wall: false,
        });
    ...
    createDBTM: function () {
        ...
        this.underObj = new okay3d.analysi.Underground(viewer, {
    ...
    createPDPX: function () {
        ...
        this.slope =  new okay3d.analysi.Slope({
            viewer: this.viewer,
            point: {
                pixelSize: 9,
    ...
    selectedPQMX: function () {
        ...
        viewer.mars.draw.startDraw({
            ...
            success: function (entity) { //绘制成功后回调
                ...
                var tileset = okay3d.tileset.pick3DTileset(viewer, positions);//拾取绘制返回的模型
                if (!tileset) {
                    haoutil.msg("请单击选择模型");
                    return;
                }
                that.clipTileset = new okay3d.tiles.TilesClipPlan(tileset);
    ...
    drawMxypPoly: function (flatHeight) {
        ...
        viewer.mars.draw.startDraw({
            ...
            success: function (entity) { //绘制成功后回调
                ...
                that.flatObj = new okay3d.tiles.TilesFlat({
                    viewer: that.viewer,
                    tileset: tileset,
                    positions: positions,
    ...
    addMxcjPoly: function (positions, clipOutSide) {
        ...
        var tileset = okay3d.tileset.pick3DTileset(this.viewer, positions);//拾取绘制返回的模型
        if (!tileset) {
            return false;
        }

        this.tilesetClip = new okay3d.tiles.TilesClip({
            viewer: this.viewer,
            tileset: tileset,
            positions: positions,
