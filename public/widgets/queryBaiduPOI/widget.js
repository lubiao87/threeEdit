...
//模块：
var widget_queryBaiduPOI = okay3d.widget.bindClass(okay3d.widget.BaseWidget.extend({
    ...
    configBaidu: {
        "key": ["tG5XsHqezUvBgTMKFgCelEoedIDGOEkw"],
    ...
    showPOIArr: function (arr) {
        ...
        $(arr).each(function (i, item) {
            ...
            var wgsMpt = okay3d.pointconvert.bd2wgs([jd, wd]);
